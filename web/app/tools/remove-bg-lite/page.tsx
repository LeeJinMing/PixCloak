    ...
    <>
      ...
      <div className="container" style={{ display: 'grid', gap: 12 }}>
        ...
        <div className="tool-guide-stack">
          <ToolGuideSection title="When to Use This Tool">
            <p>
            ...
            <table className="tool-table">
              ...
              <tbody>
                <tr>
                  <td>Processing</td>
                  <td>✅ 100% local (no upload)</td>
                  <td>Uploads to server</td>
                </tr>
                <tr>
                  <td>Privacy</td>
                  <td>✅ Complete (offline)</td>
                  <td>Images uploaded</td>
                </tr>
                <tr>
                  <td>Free Limit</td>
                  <td>✅ Unlimited</td>
                  <td>50 images/month</td>
                </tr>
                <tr>
                  <td>Speed</td>
                  <td>✅ Instant (1-2 seconds)</td>
                  <td>5-10 seconds (upload + process)</td>
                </tr>
                <tr>
                  <td>Best For</td>
                  <td>Solid backgrounds</td>
                  <td>✅ Complex backgrounds, hair/fur</td>
                </tr>
                <tr>
                  <td>Works Offline</td>
                  <td>✅ Yes</td>
          ...
          <ToolGuideSection title="How to Remove Background">
          ...
          <ToolGuideSection title="Tips for Best Results">
