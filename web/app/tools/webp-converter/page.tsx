...
export default function Page() {
  return (
    <>
      ...
      <div className="container" style={{ display: 'grid', gap: 12 }}>
        <div className="card">
          <h1 className="page-hero-title">Free WebP Converter: Convert JPG/PNG to WebP (No Upload)</h1>
        ...
        <div className="tool-guide-stack">
          <ToolGuideSection title="What is WebP?">
            <p>
          ...
          <ToolGuideSection title="WebP vs JPG vs PNG">
            <table className="tool-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td style={{ color: '#22c55e' }}>✓ Smallest</td>
                  <td>Medium</td>
                  <td style={{ color: '#ef4444' }}>✗ Largest</td>
                </tr>
                <tr>
                  <td><strong>Quality</strong></td>
                  <td style={{ color: '#22c55e' }}>✓ Excellent</td>
                  <td>Good</td>
                  <td style={{ color: '#22c55e' }}>✓ Lossless</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style={{ color: '#22c55e' }}>✓ Yes</td>
                  <td style={{ color: '#ef4444' }}>✗ No</td>
                  <td style={{ color: '#f59e0b' }}>~ APNG only</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>Websites, apps</td>
                  <td>Photos, general</td>
                  <td>Logos, graphics</td>
                </tr>
              </tbody>
            </table>

            <p><strong>Example:</strong> 500KB JPG → 350KB WebP (30% smaller, same quality)</p>
          </ToolGuideSection>

          <ToolGuideSection title="When to Use WebP">
            <h3>✅ Perfect For</h3>
            <ul>
          ...
          <ToolGuideSection title="How to Convert to WebP">
          ...
          <ToolGuideSection title="WebP Quality Settings">
          ...
          <ToolGuideSection title="Browser Support & Fallback Strategy">
            ...
            <pre className="tool-code-block">{`<picture>
  ...
  <img src="image.jpg" alt="Description">
          ...
          <ToolGuideSection title="WebP for SEO & Performance">
