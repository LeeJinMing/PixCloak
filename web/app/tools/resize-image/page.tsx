  ...
  return (
    <>
      ...
      <div className="container" style={{ display: 'grid', gap: 12 }}>
        <div className="card">
          <h1 className="page-hero-title">Free Image Resizer: Resize to Exact Dimensions (No Upload)</h1>
        ...
        <div className="tool-guide-stack">
          <ToolGuideSection title="Why Resize Images?">
          ...
          <ToolGuideSection title="Common Resize Scenarios">
          ...
          <ToolGuideSection title="How to Resize Images">
          ...
          <ToolGuideSection title="Best Practices for Resizing">
          ...
          <ToolGuideSection title="Common Mistakes to Avoid">
          ...
          <ToolGuideSection title="Batch Resizing">
