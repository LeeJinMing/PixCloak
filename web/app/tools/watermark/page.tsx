  ...
  return (
    <>
      ...
      <div className="container" style={{ display: 'grid', gap: 12 }}>
        <div className="card">
          <h1 className="page-hero-title">Free Watermark Tool: Add Text to Images (No Upload)</h1>
        ...
        <div className="tool-guide-stack">
          <ToolGuideSection title="Why Add Watermarks?">
          ...
          <ToolGuideSection title="Watermark Options Explained">
            <h3>Position</h3>
            <ul>
          ...
          <ToolGuideSection title="Best Practices for Professional Watermarking">
          ...
          <ToolGuideSection title="Watermarking for Photographers">
          ...
          <ToolGuideSection title="Batch Processing Workflow">
          ...
          <ToolGuideSection title="Common Questions">
