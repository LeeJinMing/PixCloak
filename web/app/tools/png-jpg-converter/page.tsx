  ...
  return (
    <>
      ...
      <div className="container" style={{ display: 'grid', gap: 12 }}>
        <div className="card">
          <h1 className="page-hero-title">Free PNG to JPG & JPG to PNG Converter (No Upload)</h1>
        ...
        <div className="tool-guide-stack">
          <ToolGuideSection title="PNG to JPG: When & Why">
          ...
          <ToolGuideSection title="JPG to PNG: When & Why">
          ...
          <ToolGuideSection title="PNG vs JPG: Quick Comparison">
            <table className="tool-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Large (3-5MB for photos)</td>
                  <td>✅ Small (300-500KB)</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>✅ Lossless (no quality loss)</td>
                  <td>Lossy (slight quality loss)</td>
                </tr>
                <tr>
                  <td><strong>Best For</strong></td>
                  <td>Logos, screenshots, text, transparency</td>
                  <td>✅ Photos, web, email, social</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>✅ No quality loss on re-save</td>
                  <td>Quality degrades on re-save</td>
                </tr>
                <tr>
                  <td><strong>Loading Speed</strong></td>
                  <td>Slow (large files)</td>
          ...
          <ToolGuideSection title="How to Convert PNG to JPG">
            <ol>
          ...
          <ToolGuideSection title="How to Convert JPG to PNG">
            <ol>
          ...
          <ToolGuideSection title="Batch Conversion">
            <p>
          ...
          <ToolGuideSection title="Common Use Cases">
            <h3>PNG to JPG</h3>
            <ul>
