...
export const metadata: Metadata = {
  ...
  description: "Change JPEG to WebP format and reduce file size by 30-50% with same quality. Free online converter works in browser—no upload, no limits. Batch convert multiple images at once.",
  alternates: {
