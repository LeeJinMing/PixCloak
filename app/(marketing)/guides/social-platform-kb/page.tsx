...
export const metadata: Metadata = {
  title: "Social Media Image Size Limits (LinkedIn, Twitter, Instagram) | PixCloak",
  description: "Exact image size requirements for LinkedIn (8MB), Twitter (5MB), Instagram (30MB), Facebook (10MB). Compress to exact KB targets. Works for profile pics, posts, stories.",
  alternates: {
