...
export const metadata: Metadata = {
  ...
  description: "Compare JPEG and WebP file sizes and quality. WebP is 30-50% smaller at same quality. See when to use each format for websites, social media, and email. Free comparison tool.",
  alternates: {
