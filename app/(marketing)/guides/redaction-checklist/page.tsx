...
export const metadata: Metadata = {
  ...
  description: "Essential checklist: blur faces, hide license plates, remove EXIF/GPS, black out text. Prevent doxxing and identity theft. Use irreversible redaction methods for maximum privacy.",
  alternates: {
