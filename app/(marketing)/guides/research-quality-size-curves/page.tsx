...
import ShareButtons from "@/app/guides/og-share-buttons";
  ...
  return (
    <div className="container" style={{ display: 'grid', gap: 16 }}>
      ...
      <div className="card">
        ...
        <ShareButtons url="/guides/research-quality-size-curves" title="Quality vs Size curves for JPEG/WebP (local benchmark)" />
      </div>
    </div>
  );
}
