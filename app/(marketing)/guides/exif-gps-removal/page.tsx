...
export const metadata: Metadata = {
  title: "Remove GPS & EXIF Data from Photos (Free, 2 Minutes) | PixCloak",
  description: "Strip location, camera info, and metadata from photos before sharing. Protects your privacy—prevents stalking and address leaks. Works on iPhone, Android, desktop. No upload needed.",
  alternates: {
