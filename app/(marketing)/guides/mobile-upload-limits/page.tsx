...
export const metadata: Metadata = {
  title: "Image Upload Limits for iPhone & Android (200KB-5MB Guide) | PixCloak",
  description: "Comprehensive list of mobile upload limits for forms, job applications, government portals. Reduce images to 200KB, 500KB, or 1MB for iPhone/Android. No app download needed.",
  alternates: {
