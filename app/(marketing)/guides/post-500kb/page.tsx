...
export const metadata: Metadata = {
  title: "Prepare Images for Social Posts at 500KB (Facebook, Forums) | PixCloak",
  description: "Compress photos to 500KB for social media posts, forums, blog uploads. Maintains high quality. Works for Facebook, Reddit, Medium. Batch process multiple images at once.",
  alternates: {
