...
export const metadata: Metadata = {
  ...
  description: "Reduce image file size to 1MB for portfolios, university applications, and high-quality submissions. Preserves excellent detail. Works for JPEG, PNG, WebP—no upload required.",
  alternates: {
