...
export const metadata: Metadata = {
  title: "How to Share Photos Anonymously (Remove All Identifying Info) | PixCloak",
  description: "Complete guide: blur faces, hide license plates, black out addresses, remove EXIF/GPS. Share safely on social media, forums, marketplace. Prevent doxxing and identity theft.",
  alternates: {
