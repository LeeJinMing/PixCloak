...
export const metadata: Metadata = {
  title: "Create Profile Picture at 200KB (LinkedIn, Job Sites) | PixCloak",
  description: "Compress profile photos to exactly 200KB for LinkedIn, job applications, government portals. Maintains quality. Works on any device—no app download. Resize to 512-1024px square.",
  alternates: {
