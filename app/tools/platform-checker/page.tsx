...
const RULES: Rule[] = [
  {
    ...
    maxKB: 200,
    notes: "200KB 通常体验更佳",
    ctas: [{ label: "200KB", href: "/?kb=200" }, { label: "Resize 1920", href: "/guides/resize-to-1920" }],
  },
  {
    name: "Job/Forms (General)",
    maxKB: 500,
    notes: "常见上限 500KB",
    ctas: [{ label: "500KB", href: "/?kb=500" }, { label: "Clean EXIF", href: "/guides/exif-gps-removal" }],
  },
  {
    name: "Portfolio/Web Hero",
    maxKB: 800,
    maxW: 1920,
    notes: "建议最长边 1920px",
    ctas: [{ label: "800KB", href: "/?kb=800" }, { label: "Resize 1920", href: "/guides/resize-to-1920" }],
  },
  {
    ...
    maxW: 1280,
    maxH: 720,
    notes: "1280×720 ≤ 200KB",
    ctas: [{ label: "200KB", href: "/?kb=200" }],
  },
];
