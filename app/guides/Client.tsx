...
export default function GuidesClient() {
  const items = [
    ...
    { href: '/guides/post-500kb', title: 'Prepare 500KB post images', summary: 'Good for many feeds and forms.', content: (<div><ol style={{ paddingLeft: 18, margin: '6px 0' }}><li>Open /compress?kb=500</li><li>Width ≤ 1920px</li></ol><a className="pill" href="/guides/post-500kb">Open full guide</a></div>) },
    ...
    { href: '/guides/export-without-metadata-zh', title: '中文：无元数据导出', summary: '重新编码去除 EXIF/GPS（本地处理）。', content: (<div><ul style={{ paddingLeft: 18, margin: '6px 0' }}><li>JPEG/WebP/PNG</li><li>本地处理</li></ul><a className="pill" href="/guides/export-without-metadata-zh">打开</a></div>) },
    { href: '/guides/compress-to-target-kb-zh', title: '中文：按目标体积压缩', summary: '二分法调质，命中 200/500KB。', content: (<div><ol style={{ paddingLeft: 18, margin: '6px 0' }}><li>/compress?kb=200</li><li>ZIP 批量</li></ol><a className="pill" href="/guides/compress-to-target-kb-zh">打开</a></div>) },
    { href: '/guides/resize-longest-side-zh', title: '中文：按最长边缩放', summary: '先缩放到 1920px，再压缩。', content: (<div><ol style={{ paddingLeft: 18, margin: '6px 0' }}><li>Resize=Longest</li><li>1920</li></ol><a className="pill" href="/guides/resize-longest-side-zh">打开</a></div>) },
    ...
    { href: '/guides/privacy-compliance', title: 'Privacy & compliance checklist', summary: 'Redact + remove EXIF/GPS locally. No upload.', content: (<div><ul style={{ paddingLeft: 18, margin: '6px 0' }}><li>Redact sensitive areas</li><li>Remove EXIF/GPS</li></ul><a className="pill" href="/guides/privacy-compliance">Open checklist</a></div>) },
    { href: '/guides/research-quality-size-curves', title: 'Research: quality vs size curves', summary: 'Method to benchmark JPEG/WebP at target KBs.', content: (<div><ul style={{ paddingLeft: 18, margin: '6px 0' }}><li>1920px longest</li><li>200/300/500/800KB</li></ul><a className="pill" href="/guides/research-quality-size-curves">Open research</a></div>) },
